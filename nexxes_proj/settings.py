...
SECRET_KEY = 'django-insecure-#cft*(#o*x!v!m1%p^xrew*ze^278$et7er!znh+%rydw5sh%t'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, '/templates'), os.path.join(BASE_DIR, 'authentication/templates', 'allauth')],
...
ACCOUNT_EMAIL_CONFIRMATION_EXPIRE_DAYS = 1    # allauth
ACCOUNT_USERNAME_MIN_LENGTH = 1     # allauth

ACCOUNT_LOGOUT_REDIRECT_URL = '/'  # allauth
ACCOUNT_LOGIN_ATTEMPTS_LIMIT = 500  # allauth
